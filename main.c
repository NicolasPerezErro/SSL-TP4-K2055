...
int main(int argc, char *argv[])
{
    ...
    /***************************Se abre el Archivo Fuente******************/ // verifica errores posibles
    if (argc == 1)
    {
...
void Programa(void)
{
    ...
    Comenzar(); // Inicializaciones, no hace nada aca.
    Match(INICIO);
    ListaSentencias();
    Match(FIN);
}
...
TOKEN scanner()
{
    int tabla[NUMESTADOS][NUMCOLS] =
        ...
        /*0*/ {{1, 3, 5, 6, 7, 8, 9, 10, 11, 14, 13, 0, 14},
               ...
               /*2*/ {14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14}, /* ID  */
               /*3*/ {4, 3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4},
               /*4*/ {14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14},  /*  CTE */
               ...
               /*12*/ {14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14},  /* ASIG */
               /*13*/ {14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14},  /* fdt  */
    ...
    {
    case 2:
        if (col != 11) // si el car�cter espureo no es blanco�
        {
